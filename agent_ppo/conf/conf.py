class Config:
    ...
    MPC_XY_SLEW_LIMIT = 0.37125
    MPC_TAKEOFF_Z_SLEW_LIMIT = 0.30375
    MPC_Z_SLEW_LIMIT = 0.675
    ...
    OBSTACLE_NORMAL_TRIGGER_MIN = 0.80
    OBSTACLE_BASE_MARGIN = 0.26
    OBSTACLE_SPEED_MARGIN_GAIN = 0.08
    OBSTACLE_DETOUR_MARGIN = 0.42
    OBSTACLE_DETOUR_ADVANCE = 0.45
    OBSTACLE_AVOID_HOLD_FRAMES = 18
    OBSTACLE_WALL_MARGIN = 0.32
    OBSTACLE_EMERGENCY_MARGIN = 0.24
