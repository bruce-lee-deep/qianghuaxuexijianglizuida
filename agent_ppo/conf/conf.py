class Config:
    ...
    MPC_GRAVITY = 9.81
    MPC_MAX_ROLL_RAD = 0.12
    MPC_MAX_PITCH_RAD = 0.12
    MPC_ATT_KP_ROLL = 2.4
    MPC_ATT_KP_PITCH = 2.4
    MPC_ATT_KD_ROLL = 0.18
    MPC_ATT_KD_PITCH = 0.18
    MPC_MAX_ROLL_RATE = 0.28
    MPC_MAX_PITCH_RATE = 0.28
    MPC_THRUST_GAIN = 0.020
    MPC_THRUST_MIN = -0.25
    MPC_THRUST_MAX = 0.25
    MPC_THRUST_COMP_MIN_COS = 0.35
    MPC_TARGET_XY_CLIP = 2.50
    MPC_TARGET_Z_CLIP = 1.20
    MPC_GHOST_TARGET_DIST = 0.50
    MPC_STARTUP_FRAMES = 24
    MPC_STARTUP_HORIZONTAL_LOCK_STEPS = 30
    ...
    MPC_TAKEOFF_XY_ACCEL_LIMIT = 0.34
    MPC_TAKEOFF_MAX_TILT_RAD = 0.045
    MPC_TAKEOFF_STRONG_TILT_RAD = 0.026
    MPC_CMD_MAX_TILT_RAD = 0.20
    MPC_TAKEOFF_XY_SLEW_LIMIT = 0.035
    MPC_XY_SLEW_LIMIT = 0.085
    MPC_TAKEOFF_Z_SLEW_LIMIT = 0.07
    MPC_Z_SLEW_LIMIT = 0.14
